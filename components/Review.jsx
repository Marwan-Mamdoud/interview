      ...
      <div className="mt-32 flex flex-col items-center relative justify-between mb-56">
        ...
        <div className="w-2/3 absolute reviews opacity-0 top-16 review1 mx-auto text-center ">
          <div className="fontReview text-2xl font-serif text-[#394145] mb-5">
            <p>Once you step into the villa you feel like royalty! The</p>
            <p>spectacular view, your private pool and the space that you</p>
            <p>call your own during the stay.</p>
          </div>
        ...
        <div className="w-2/3 absolute reviews opacity-0 top-16 review2 mx-auto text-center ">
          <div className="fontReview text-2xl font-serif text-[#394145] mb-5">
            <p>
              I could have stayed at Hidden Hills for the rest of my life. It
            </p>
            <p>
              {" "}
              was easily the nicest, most relaxing and beautiful place that I
            </p>
            <p> have ever stayed.</p>
          </div>
          <p className="font-sans text-[#7e8083] text-[10px] tracking-[.2rem]">
        ...
        <div className="w-2/3 reviews opacity-0 top-16 absolute review3 mx-auto text-center ">
          <div className="fontReview text-2xl font-serif text-[#394145] mb-5">
            <p> Absolute perfection. The service, the decor, the food, the</p>
            <p>
              villas, the view, the staff, the everything. It feels like youve
            </p>
            <p>cmoved to your own estate.</p>
          </div>
          <p className="font-sans text-[#7e8083] text-[10px] tracking-[.2rem]">
